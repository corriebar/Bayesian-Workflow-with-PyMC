...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_14_0.png)
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_16_1.png)
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_18_1.png)
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_20_1.png)
...
```
    ...
    NUTS: [theta, tau, mu]
    Sampling 2 chains: 100%|██████████| 1100/1100 [00:05<00:00, 186.70draws/s]
    There were 116 divergences after tuning. Increase `target_accept` or reparameterize.
    The acceptance probability does not match the target. It is 0.4765508278645465, but should be close to 0.8. Try to increase the number of tuning steps.
    There were 3 divergences after tuning. Increase `target_accept` or reparameterize.
    The acceptance probability does not match the target. It is 0.8835825878558562, but should be close to 0.8. Try to increase the number of tuning steps.
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_24_0.png)
...
```
    ...
    Multiprocess sampling (2 chains in 2 jobs)
    NUTS: [theta, tau, mu]
    Sampling 2 chains: 100%|██████████| 2000/2000 [00:07<00:00, 262.14draws/s]
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_27_0.png)
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_29_0.png)
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_31_0.png)
...
```
    ...
    Multiprocess sampling (2 chains in 2 jobs)
    NUTS: [theta_t, tau, mu]
    Sampling 2 chains: 100%|██████████| 2000/2000 [00:06<00:00, 327.73draws/s]
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_34_0.png)
...
![png](05_Convergency%20Checks_files/05_Convergency%20Checks_36_0.png)
